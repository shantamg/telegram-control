...
Use /agent inside a managed topic to inspect a grouped Runtime, Workspace, and Usage card covering its provider, model, effort, state, session, console, and context usage.
